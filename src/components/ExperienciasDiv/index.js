                    ...
                    <div className='my-auto div1 col-12 col-xl-7 col-xxl-8'>
                        <div className="d-flex flex-column flex-sm-row flex-md-row justify-content-between py-3 mb-xxl-3">
                            <div className="fs-5 d-flex flex-column justify-content-center pt-lg-5 pt-xl-0 pt-xxl-0">
                                <div className='fs-4 fw-bold'>Estágio</div>
                                <div className='fs-4 fw-bold'>Desenvolvimento de Sistemas</div>
                            </div>
                            <div className='display-5 fw-semibold align-self-sm-end'>Telecall</div>
                        </div>

                        <div className="fs-4 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                            <p className=''>Aprimorei a segurança de sistemas, impedindo injeções de SQL, com o uso de consultas
                                parametrizadas.</p>
                            <p className=''>Adequei respostas HTTP e ampliei a documentação de uma API REST da qual sou o
                                responsável.</p>
                            <p className=''>Aprimorei a legibilidade de códigos de sistemas automatizados, seguindo boas práticas e
                                facilitando
                                manutenção.</p>
                        </div>
                    </div>

                    <div className='ms-xl-5 my-auto col-12 col-xl-5 col-xxl-4'>
