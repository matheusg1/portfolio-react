            ...
            <div className='container mt-lg-5'>
                <div className="d-flex flex-column align-items-start justify-content-center flex-lg-row">
                    ...
                    <div className="d-flex flex-column justify-content-between col-12 col-md-10 col-lg-6 col-xl-6 col-xxl-6 ps-lg-3 mt-3 mt-xl-0">
                        <div className=''>
                            ...
                            <div className="fs-4 fw-medium">Web App - React</div>
                        </div>
                        <p className="fs-6">
                ...
                <div className="my-5 d-flex flex-column align-items-start justify-content-center  flex-lg-row">
                    ...
                    <div className="d-flex flex-column col-12 col-md-10 col-lg-6 col-xl-6 col-xxl-7 ps-lg-3 mt-3 mt-xl-0">
                        <div>
                            <div className="d-flex justify-content-between">
                                <div className="fs-4 fw-semibold">Instituto Jurema de Ensino</div>
                            ...
                            <div className="fs-4 fw-medium">REST API - C#</div>
                        </div>
                        <p className="fs-6">
                        ...
                        <div className="container">
                            <div className="row flex-row overflow-auto text-center flex-nowrap align-items-center">
                                <div className="fs-6 m-3 scrollbar-item bg-dark-subtle rounded-pill col-11 col-md-6 col-lg-7 col-xl-6">Autenticação via Token JWT</div>
                ...
                <div className="my-5 d-flex flex-column align-items-start justify-content-center  flex-lg-row">
                    ...
                    <div className="d-flex flex-column col-12 col-md-10 col-lg-6 col-xl-6 col-xxl-7 ps-lg-3 mt-3 mt-xl-0">
                        <div>
                            <div className="d-flex justify-content-between">
                                <div className="fs-4 fw-semibold">Instituto Jurema de Ensino
                                </div>
