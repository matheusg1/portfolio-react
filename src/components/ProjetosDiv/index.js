...
<div className="d-flex flex-column align-items-center justify-content-center flex-lg-row mt-lg-5">
    ...
    <div className="d-flex flex-column justify-content-between col-12 col-md-10 col-lg-6 col-xl-6 col-xxl-7 ps-lg-3 mt-3 mt-xl-0">
        ...
        <div className='projetos-descricao'>
            ...
            <div className='col-12 d-flex flex-wrap justify-content-center justify-content-xl-start'>
                <div className="m-1 px-4 bg-dark-subtle rounded-pill">Design minimalista e padronizado</div>
                <div className="m-1 px-4 bg-dark-subtle rounded-pill">Integrado a duas APIs</div>
                <div className="m-1 px-4 bg-dark-subtle rounded-pill">Autenticação de usuários com Supabase</div>
                <div className="m-1 px-4 bg-dark-subtle rounded-pill">Banco de dados com Supabase</div>
            </div>
        </div>
    </div>
</div>