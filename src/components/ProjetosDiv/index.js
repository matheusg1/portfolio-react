    ...
    return (
        <div className='bg-secondary-subtle min-vh-100 text-dark' id="projetos">
            ...
            <div className='container mt-lg-5'>
                ...
                <div className="my-5 d-flex flex-column align-items-center justify-content-center  flex-lg-row">
                    ...
                    <div className="d-flex flex-column col-12 col-md-10 col-lg-6 col-xl-7 col-xxl-7 ps-lg-3 mt-3 mt-xl-0">
                        <div>
                            <div className="d-flex justify-content-between">
                                <div className="fs-3 fw-semibold">Instituto Jurema de Ensino</div>
                ...
                <div className="my-5 d-flex flex-column align-items-center  justify-content-center  flex-lg-row">
                    ...
                    <div className="d-flex flex-column col-12 col-md-10 col-lg-6 col-xl-7 col-xxl-7 ps-lg-3 mt-3 mt-xl-0">
                        <div>
                            <div className="d-flex justify-content-between">
                                <div className="fs-3 fw-semibold">Instituto Jurema de Ensino
                                </div>
