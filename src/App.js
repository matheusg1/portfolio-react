...
function App() {
  ...
  return (
    <>
      ...
      <div className='bg-secondary min-vh-100 d-flex'>
        <div className='col-5'>
          <h3 className="text-white display-1 pt-5">Experiências</h3>

          <div className="d-flex flex-column flex-xl-row flex-xxl-row justify-content-between align-items-center py-3">
            <div className="fs-5 d-flex flex-column justify-content-center pt-lg-5 pt-xl-0 pt-xxl-0">
              <div>Estágio</div>
              <div>Desenvolvimento de Sistemas</div>
            </div>
            <div className='display-3 text-end'>Telecall</div>
          </div>

          <div className="fs-5 col-sm-12 col-md-12 col-lg-10 col-xl-10">
            <p>Aprimorei a segurança de sistemas, impedindo injeções de SQL, com o uso de consultas
              parametrizadas.</p>
            <p>Adequei respostas HTTP e ampliei a documentação de uma API REST da qual sou o
              responsável.</p>
            <p>Aprimorei a legibilidade de códigos de sistemas automatizados, seguindo boas práticas e
              facilitando
              manutenção.</p>
          </div>
        </div>
        <div className='col-5'>
          <div class="d-flex flex-column col-lg-6 col-xl-6 ms-xl-5 ps-xl-5">
            <div class="d-flex align-items-center">
              <img class="vertical-icon my-3" src={apiIcon} />
              <div class="d-flex flex-column align-content-center topico">
                <p class="ms-3">Tratamento de respostas HTTP</p>
                <p class="ms-3">Autenticação baseada em token</p>
              </div>
            </div>

            <div class="d-flex align-items-center">
              <img class="vertical-icon my-3" src={webIcon} />
              <div class="d-flex flex-column align-content-center topico">
                <p class="ms-3">Web Apps com ASP.Net</p>
              </div>
            </div>

            <div class="d-flex align-items-center">
              <img class="vertical-icon my-3" src={databaseIcon} />
              <div class="d-flex flex-column align-content-center topico">
                <p class="ms-3">Operações em SQL</p>
                <p class="ms-3">Entity Framework</p>
              </div>
            </div>

            <div class="d-flex align-items-center">
              <img class="vertical-icon my-3" src={testIcon} />
              <div class="d-flex flex-column align-content-center topico">
                <p class="ms-3">Testes unitários</p>
                <p class="ms-3">Testes de interface</p>
              </div>
            </div>
          </div>
          </div>
