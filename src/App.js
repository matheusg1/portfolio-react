    ...
    return (
        <>
            ...
            <div className='bg-secondary min-vh-100 text-dark' id="experiencias">
                <div className='container'>
                    <div className="display-1 fw-medium py-3">Experiências</div>
                    <div className='d-flex flex-column flex-lg-row'>
                        <div className='my-auto div1'>
                            <div className="d-flex flex-column flex-sm-row flex-md-row justify-content-between py-3">
                                <div className="fs-5 d-flex flex-column justify-content-center pt-lg-5 pt-xl-0 pt-xxl-0">
                                    <div className='fs-5 fw-bold'>Estágio</div>
                                    <div className='fs-5 fw-bold'>Desenvolvimento de Sistemas</div>
                                </div>
                            ...
                            <div className="fs-5 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                <p className='fs-4'>Aprimorei a segurança de sistemas, impedindo injeções de SQL, com o uso de consultas
                                    parametrizadas.</p>
                                <p className='fs-4'>Adequei respostas HTTP e ampliei a documentação de uma API REST da qual sou o
                                    responsável.</p>
                                <p className='fs-4'>Aprimorei a legibilidade de códigos de sistemas automatizados, seguindo boas práticas e
                                    facilitando
                                    manutenção.</p>
                            </div>
                        </div>
                        <div className='ms-lg-5 my-auto div2'>
                            <div className="d-flex flex-column">
                                <div className="d-flex align-items-center">
                                    <img className="vertical-icon my-3 me-3" src={apiIcon} />
                                ...
                                <div className="d-flex align-items-center">
                                    <img className="vertical-icon my-3 me-3" src={webIcon} />
                                    <div className="d-flex flex-column align-content-center fs-6 fw-semibold text-nowrap">
                                ...
                                <div className="d-flex align-items-center">
                                    <img className="vertical-icon my-3 me-3" src={databaseIcon} />
                                    <div className="d-flex flex-column align-content-center fs-6 fw-semibold text-nowrap">
                                ...
                                <div className="d-flex align-items-center">
                                    <img className="vertical-icon my-3 me-3" src={testIcon} />
                                    <div className="d-flex flex-column align-content-center fs-6 fw-semibold text-nowrap">
