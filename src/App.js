  ...
  return (
    <>
      <div className='bg-dark min-vh-100'>
        ...
        <div
          className="container d-flex flex-column flex-md-column flex-sm-column flex-lg-row align-items-center justify-content-around py-0 py-xxl-5 mt-md-2 mt-lg-5 mt-xl-5 mt-xxl-5">

          <div className='col-11 col-sm-8 col-md-5 col-md-4 col-lg-4 col-xl-4 col-xxl-4 text-center my-lg-5 my-xl-3 my-xxl-5'>
            <img className="img-fluid" width='400' src={imgMat} />
          </div>

          <div className="mt-0 mt-sm-0 mt-lg-5 mt-xl-5 mt-xxl-5 d-flex flex-column text-white mt-4">
      ...
      <div className='bg-light text-dark min-vh-100 d-flex flex-column' id="conhecimentos">
        <div className='container'>
          <div className='display-1 fw-medium py-3'>Conhecimentos</div>
        </div>
      ...
      <div className='bg-secondary min-vh-100 text-dark' id="experiencias">
        <div className='container'>
          <div className="display-1 fw-medium py-3 mb-xl-4 mb-xxl-5">Experiências</div>
          <div className='d-flex flex-column flex-xxl-row'>
            <div className='my-auto div1'>
              <div className="d-flex flex-column flex-sm-row flex-md-row justify-content-between py-3 mb-xxl-3">
                ...
                <div className='display-4 fw-semibold align-self-sm-end pe-5'>Telecall</div>
              </div>
            ...
            <div className='ms-lg-5 my-auto div2'>
              <div className="d-flex flex-column">
                <div className="d-flex align-items-center">
                  <img className="vertical-icon my-3 me-2" src={apiIcon} />
                  <div className="d-flex flex-column align-content-center fs-6 fw-semibold text-nowrap">
                ...
                <div className="d-flex align-items-center">
                  <img className="vertical-icon my-3 me-2" src={webIcon} />
                  <div className="d-flex flex-column align-content-center fs-6 fw-semibold text-nowrap">
                    <p className="my-0">Web Apps com ASP.Net</p>
                  </div>
                </div>

                <div className="d-flex align-items-center">
                  <img className="vertical-icon my-3 me-2" src={databaseIcon} />
                  <div className="d-flex flex-column align-content-center fs-6 fw-semibold text-nowrap">
              ...
              <div className="d-flex flex-column justify-content-between col-12 col-xl-7 col-xxl-7 ps-xl-3 mt-3 mt-xl-0">
                <div>
                  <div className='d-flex justify-content-between'>
                    <div className="fs-2 fw-semibold"><a target="_blank" className='link-dark' href="https://projeto-ressignificar.vercel.app">Projeto Ressignificar</a></div>
                    <button type="button" class="border-0 rounded-1 btn btn-outline-dark">
                  ...
                  <div className="fs-2 fw-medium">Web App - React</div>
                </div>
                <p className="fs-4">
                ...
                <div className="container">
                  <div className="row flex-row overflow-auto text-center flex-nowrap align-items-center">
                    <div className="fs-5 m-3 scrollbar-item bg-dark-subtle rounded-pill col-12 col-md-6 col-lg-5 col-xl-7 col-xxl-6">Design minimalista e padronizado</div>
                    <div className="fs-5 m-3 scrollbar-item bg-dark-subtle rounded-pill col-5 col-md-3 col-lg-2 col-xl-3">Responsivo</div>
                  </div>
                </div>
              </div>
            </div>

            <div className="pt-5 pb-2 d-flex flex-column flex-xl-row">
              ...
              <div className="d-flex flex-column justify-content-between col-12 col-xl-7 col-xxl-7 ps-xl-3 mt-3 mt-xl-0">
                <div className="fs-2 fw-semibold">Sistema escolar</div>
                <div className="fs-2 fw-medium">REST API - C#</div>
                <p className="fs-4">
                  API que permite o gerenciamento de informações de turmas/matérias/alunos relacionadas a uma escola.
                </p>
                <div className="container">
                  <div className="row flex-row overflow-auto text-center flex-nowrap align-items-center">
                    <div className="fs-5 m-3 scrollbar-item bg-dark-subtle rounded-pill col-11 col-md-6 col-lg-5 col-xl-6">Autenticação via Token JWT</div>
                    <div className="fs-5 m-3 scrollbar-item bg-dark-subtle rounded-pill col-6 col-md-4 col-lg-3 col-xl-3">Assincronismo</div>
                    <div className="fs-5 m-3 scrollbar-item bg-dark-subtle rounded-pill col-12 col-md-6 col-lg-5 col-xl-6">Documentação com Swagger</div>
