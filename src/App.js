...
function App() {
    ...
    return (
        <>
            <div className='bg-dark min-vh-100 pb-xl-5'>
                <Navbar />

                <div
                    className="container d-flex flex-column flex-md-column flex-sm-column flex-lg-row align-items-center justify-content-around py-0 py-xxl-5 mt-md-2 mt-lg-5 mt-xl-0 mt-xxl-5">
                    ...
                    <div className="mt-0 mt-sm-0 mt-4 mt-lg-5 mt-xl-3 mt-xxl-5 d-flex flex-column text-white">
                        <div className="display-1 fw-normal">Matheus</div>
                        <div className="display-1 fw-normal text-end">Gomes</div>
                        <div className="display-6 fw-medium text-center">Desenvolvedor Full Stack</div>
                    </div>
